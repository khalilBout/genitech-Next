...
const EditPortfili = ({ portfolioData }) => {
  ...
  const [form, setForm] = useState({
    ...
    title_en: portfolioData.title_en,
    description: portfolioData.description,
    description_en: portfolioData.description_en,
    // mainImg: blogData.mainImg,
  });
  const [newImage, setNewImage] = useState(portfolioData.mainImg);
  const [newListImage, setListNewImage] = useState([
    ...portfolioData.listImage,
  ]);
  const [newCty, setNewCty] = useState([...portfolioData.category]);
          ...
          <form className="space-y-4 my-4">
            <div className=" my-4 flex flex-col xl:flex-row gap-2">
              ...
              <input
                ...
                name="title_en"
                // value={form.title_en}
                defaultValue={portfolioData.title_en}
                onChange={handleChange}
              />
            </div>
            {/* caty  */}
            ...
            <div className="flex flex-col gap-4">
              ...
              <div>
                <textarea
                  ...
                  defaultValue={portfolioData.description_en}
                  onChange={handleChange}
                />
              </div>
            </div>
          ...
          <div className="flex justify-center items-center ">
            {newImage ? (
              <div className="flex flex-col gap-2 justify-center items-center text-slate-200">
                <h1 className="py-4 text-xl font-Title">صورة العمل </h1>
