...
import why from "@/public/PhoneApp/why.webp";
...
const WhyUs = () => {
  ...
  const dataBox = [
    { title: t("phoneApp.why.box-1"), image: box1 },
    { title: t("phoneApp.why.box-2"), image: box2 },
    { title: t("phoneApp.why.box-3"), image: box3 },
    { title: t("phoneApp.why.box-4"), image: box4 },
  ];
  return (
