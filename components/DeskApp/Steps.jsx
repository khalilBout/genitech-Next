...
const Steps = () => {
  ...
  const dataSteps = [
    {
      title: t("deskApp.steps.step-1.title"),
      desc: t("deskApp.steps.step-1.desc"),
    },
    {
      title: t("deskApp.steps.step-2.title"),
      desc: t("deskApp.steps.step-2.desc"),
    },
    {
      title: t("deskApp.steps.step-3.title"),
      desc: t("deskApp.steps.step-3.desc"),
    },
    {
      title: t("deskApp.steps.step-4.title"),
      desc: t("deskApp.steps.step-4.desc"),
    },
  ];
  return (
      ...
      <div className=" mdl:w-[90%] font-Title  mx-4 flex flex-col justify-center items-center ">
        ...
        <div className=" relative w-full mt-6 flex flex-row md:flex-col justify-center md:justify-between  md:min-h-[400px] lg:w-[80%]">
          <div className=" opacity-20 md:opacity-60 mdl:md:opacity-90 w-[60%]  sml:w-[40%] h-[80%] absolute top-1/3 md:top-1/2  left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            <Image src={deskStep} alt="image" className="w-full h-auto" />
          </div>
          {/* box  */}
