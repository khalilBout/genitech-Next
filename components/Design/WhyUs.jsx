...
import whyDesg from "@/public/design/whyDesg.webp";
...
const WhyUs = () => {
  ...
  const dataBox = [
    { title: t("design.why.box-1"), image: box1 },
    { title: t("design.why.box-2"), image: box2 },
    { title: t("design.why.box-3"), image: box3 },
    { title: t("design.why.box-4"), image: box4 },
  ];
  return (
